...
- Häufige Stolperfallen beim Python-Skript:
  ...
  - Setze bei langen GPU-Initialisierungen den Timeout passend (Arg `--timeout` oder env `MYCELIA_DRIVER_TIMEOUT`, Default 90 s), damit kein unnötiger Fallback ausgelöst wird.
